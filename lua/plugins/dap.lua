...
vim.keymap.set("n", "<leader>dv", function() dapui.toggle() end, { desc = "Toggle debug view" })

vim.api.nvim_create_autocmd("FileType", {
	pattern = "go",
	once = true,
	callback = function() require("dap-go").setup() end,
})
vim.api.nvim_create_autocmd("FileType", {
	pattern = "python",
	once = true,
	callback = function() require("dap-python").setup("debugpy-adapter") end,
})
